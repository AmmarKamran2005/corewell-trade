...
const TRANSFERS: Transfer[] = [
  { id: 1, transferNo: "TRF-CEN-26-0014", date: "2026-04-30", fromWh: "Central Main",       toWh: "Northgate Distribution", itemCount: 8, totalUnits: 240, status: "IN_TRANSIT",       initiatedBy: "Hugo Ramos", notes: "Urgent stock for Northgate launch event" },
  ...
  { id: 6, transferNo: "TRF-CEN-26-0010", date: "2026-04-24", fromWh: "Central Main",       toWh: "Harbour Hub",       itemCount: 2, totalUnits: 50,  status: "REJECTED",         initiatedBy: "Hugo Ramos", notes: "Rejected — destination over capacity" },
];
